...
rm(tickets_day_rev, tickets_day_rev2)
```

From the "Distribution of Median Daily Revenue," we see that Tuesday appears to generate more revenue than the average. However, Friday and Saturday appear to have significantly less than average 
