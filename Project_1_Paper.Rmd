...
We decided to do a $\chi^2$ test in order to determine whether the violation type is independent of the day of the week. The following is the contignency table:
...
The $\chi^2$ test with `r chi$parameter` degrees of freedom resulted in a $\chi^2$ statistic of `r round(chi$statistic,3)` and a p-value of `r round(chi$p.value,10)`. This means that the violation types are independent of the days of the week. 
