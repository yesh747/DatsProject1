...
##SMART Questions 
_**In the San Francisco TOLE program, is the type of violation issued in the citation independent from the day of the week?**_
...
The $\chi^2$ test with `r chi$parameter` degrees of freedom resulted in a $\chi^2$ statistic of `r round(chi$statistic,3)` and a p-value of approximately `r round(chi$p.value,10)`. Thus, we reject the null hypothesis that the violation types are *not* independent of the days of the week. 
