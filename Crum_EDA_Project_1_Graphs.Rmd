...
AverageWeek <- mean(WeeklyTotals$Total)
AverageWeek

MedianWeek <- median(WeeklyTotals$Total)
MedianWeek

ggplot(WeeklyTotals, aes(x = Total)) + geom_histogram(fill = "red", color = "black", binwidth = 500) + geom_vline(xintercept = AverageWeek, linetype = "longdash", colour = "blue") + geom_vline(xintercept = MedianWeek, linetype = "twodash" , colour = "green")
...
ggplot(MonthlyTotals, aes(x = Total)) + geom_histogram(fill = "red", color = "black", binwidth = 2000) + geom_vline(xintercept = AverageMonth, linetype = "longdash", colour = "blue") + geom_vline(xintercept = MedianMonth, linetype = "twodash" , colour = "green")
sd.month <- sd(MonthlyTotals$Total)
sd.month
...
ggplot(DailyTotals, aes(x = Total)) + geom_histogram(fill = "red", color = "black", binwidth = 100) + geom_vline(xintercept = AverageDay, linetype = "longdash", colour = "blue") + geom_vline(xintercept = MedianDay, linetype = "twodash" , colour = "green")
sd.day <- sd(DailyTotals$Total)
sd.day
```
