...
#summary stats and histogram of fine amount
summary(tickets$Fine.Amount)
hist(tickets$Fine.Amount)
...
fine.plot <- ggplot(data = fine_by_year_viol, aes(x = Citation.Issue.Year, y = median))
fine.plot <- fine.plot + geom_line() + geom_point() 
fine.plot <- fine.plot + facet_wrap(~ Violation)
fine.plot
