...
ByHour <- tickets %>% group_by(Citation.Issue.Hour) %>% summarise(Percentage = n()/nrow(tickets) * 100)
ByHour

ggplot(tickets, aes(x = Citation.Issue.Hour)) + geom_histogram(binwidth = 1, fill = "red", color = "black")
```
...
```
```{r}
SanFranCensus <- readOGR(dsn = "C:/Users/JackCrum/Downloads/", layer = "SanFran.shp")
