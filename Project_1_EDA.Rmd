...
#Plot Daily Average Revenue
p <- ggplot(tickets.violWeekday, aes(x=Violation, y=Daily.Average.Revenue, fill=Weekday))
p + geom_col() + coord_flip() + theme(plot.title = element_text(hjust = 0.5)) + ggtitle("Daily Average Revenue by Violation") + ylab("Daily Average Revenue") + scale_y_continuous(label = comma)
...
p1 + geom_density(alpha = .6) + labs(fill = "Top 3 Violations") + ggtitle("Density Distribution of Citation Hour by Top 3 Violations") + theme(plot.title = element_text(hjust = 0.5))
