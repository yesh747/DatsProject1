...
ggplot(data=tickets) + geom_bar(mapping = (aes(Violation)), fill = "blue", color = "black") 
```
...
ggplot(tickets_by_viol) + geom_col(mapping = aes(x=Violation, y=Total.Revenue), fill = "blue", color = "black") + scale_y_continuous(labels = comma)
