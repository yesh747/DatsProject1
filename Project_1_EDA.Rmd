...
#Figure out which ciolations are top 3 types
...
#Plot all violations by hour; NOTE: This is not very helpful
p2 <- ggplot(tickets, aes(Citation.Issue.Hour, fill = Violation))
